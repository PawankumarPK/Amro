...
class SpeechRecognization(private val conversionCallback: ConversionCallback) : TranslatorFactory.IConverter {

    private val TAG = SpeechRecognization::class.java.name

    override fun initialize(message: String, appContext: Activity): SpeechRecognization {
